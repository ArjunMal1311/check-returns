    ...
    return (
        <div className={`bg-[url("/start_investing_bg.jpg")] h-[350px] bg-center bg-cover mt-16 flex justify-center items-center flex-col ${InterScript.className}`}>
            ...
            <div className='flex space-x-2 sm:w-[350px] w-[250px] justify-around mt-10'>
                <div className=' w-[150px] text-center rounded-lg bg-white text-[#202020] px-3 py-2 font-semibold select-none' onClick={() => { router.push("/calculator") }}>Calculator</div>
                <div className='w-[150px] text-center bg-[#29abe2] rounded-lg px-4 py-2 text-[16px] font-semibold text-white select-none' onClick={() => { router.push("/login") }}>Login</div>
            </div>
        </div>
    )
}
